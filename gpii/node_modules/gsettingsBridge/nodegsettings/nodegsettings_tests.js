...
var testStuff = function () {
    ...
    for (var i = 0; i < keys.length; i++) {
        console.log("Ok: " + keys[i]);
    }
    console.log("Done Testing Stuff");
};
