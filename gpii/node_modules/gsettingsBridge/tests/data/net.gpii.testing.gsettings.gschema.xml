...
<schemalist>
  ...
  <schema path="/net/gpii/testing/gsettings/multi-get1/" id="net.gpii.testing.gsettings.multi-get1" gettext-domain="gpii-testing-schemas">
    ...
    <schema path="/net/gpii/testing/gsettings/launch/" id="net.gpii.testing.gsettings.launch" gettext-domain="gpii-testing-schemas">
    <key type="b" name="start-flag">
      <default>false</default>
      <summary>Boolean settings</summary>
      <description>Test field - true or false - used for testing the gsettings launch handler</description>
    </key>
  </schema>
