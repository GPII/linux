...
(function () {
    ...
    fluid.defaults("gpii.orca.settingsHandler", {
        ...
        listeners: {
            onCreate: {
                funcName: "gpii.orca.settingsHandler.onCreate",
                args: ["{that}"]
            }
        }
    });
    ...
    gpii.orca.settingsHandler.onCreate = function (that) {
    ...
    gpii.orca.settingsHandler.set = function (that, payload) {
        var results = gpii.settingsHandlers.invokeSettingsHandler(that.setImpl, payload);
