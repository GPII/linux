...
makePac (PkPackage *package) {
  ...
  pkString = pk_package_get_id (package);
  value = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pac->Set (key, value);

  pkString = "name";
  key = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pkString = pk_package_get_name (package);
  value = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pac->Set (key, value);

  pkString = "version";
  key = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pkString = pk_package_get_version (package);
  value = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pac->Set (key, value);

  pkString = "arch";
  key = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pkString = pk_package_get_arch (package);
  value = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pac->Set (key, value);

  pkString = "data";
  key = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pkString = pk_package_get_data (package);
  value = Nan::Encode (pkString, strlen (pkString), Nan::UTF8);
  pac->Set (key, value);
...
NAN_METHOD(searchPackage) {
  ...
  result = Nan::New<Array>(array->len);
