...
var orcaProcInfo = processesBridge.initProcInfoNotRunning ("orca");
var orcaProcInfos = processesBridge.findProcessesByCommand ("orca");
...
states.trackRunState =
  processesBridge.trackRunState (orcaProcInfo, runStateChangeHandler);
states.trackState =
  processesBridge.trackState (orcaProcInfo, stateChangeHandler);
...
seekInput.on ("line", function (answer) {
  ...
  switch (answer.trim()) {
    case "yes":
      ...
      processesBridge.stopTrackingState (stateChangeHandler, states.trackState);
      seekInput.close();
      break;
