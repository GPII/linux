...
jqUnit.test("Running tests for Linux/GNOME Process Reporter", function () {
    ...
    var aValue = gsettings.getSingleKey(
        "org.gnome.desktop.a11y.applications", "screen-magnifier-enabled"
    );
    jqUnit.assertTrue("Checking retrieval of a boolean setting",
                       gpii.processReporter.checkSetting(
                           "org.gnome.desktop.a11y.applications",
                           "screen-magnifier-enabled",
                           aValue)
    );
    aValue = gsettings.getSingleKey(
        "org.gnome.desktop.a11y.magnifier", "mag-factor"
    );
    jqUnit.assertTrue("Checking retrieval of a numeric setting",
                       gpii.processReporter.checkSetting(
    ...
    aValue = "foobar";
    jqUnit.assertFalse("Checking retrieval of a non-existent setting",
                       gpii.processReporter.checkSetting(
                           "org.gnome.desktop.a11y.applications",
                           "screen-magnifier-enabled",
                           aValue)
