...
(function() {
    ...
    procTests.hasStateChanged = function (procInfo) {
      ...
      // Case:  process not in the current list, implies no longer running.
      if (theProc === null) {
    ...
    jqUnit.test (
        ...
        function() {
          ...
          // Give orca some time to quit itself.  Then look for the process
          // whose id matches the running 'orca' process from above.
          procTests.wait10sec();
          ...
          jqUnit.assertEquals ("Orca process changed state",
                               "NoSuchProcess", newState);
