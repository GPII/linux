...
var orcaProcInfo = processes.initNotRunning ("orca");
...
var intervalID = processes.trackRunState (orcaProcInfo, stateChangeHandler);
...
seekInput.question ("Stop? ", function (answer) {
  ...
  if (answer === "yes") {
    ...
    // Cease periodic check of orca's run-state.
    processes.stopTrackingRunState (stateChangeHandler, intervalID);
