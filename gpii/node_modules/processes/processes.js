...
(function() {
    ...
    var startStopNotify = new events.EventEmitter();
    ...
    gpii.processes.monitorRunningChanged = function (monitor) {
      ...
      if (gpii.processes.hasSwitchedRunState (monitor)) {
        ...
        startStopNotify.emit ("switchedRunState", monitor.procInfo);
      }
    };
    ...
    gpii.processes.trackRunState = function (handler) {
      startStopNotify.on ("switchedRunState", handler);
    };

    gpii.processes.stopTrackingRunState = function (handler) {
      startStopNotify.removeListener ("switchedRunState", handler);
    };      
