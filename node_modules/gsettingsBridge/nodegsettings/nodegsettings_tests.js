...
var testBooleanValuesCallback1 = false;
var testBooleanValuesCallback2 = false;
var testBooleanValues = function() {
    ...
    // Todo need to setup an event for these assertions, they run too fast,
...
var testDecimalValues = function() {
    ...
    assert.ok(ret);
    var ret = gsettings.set_gsetting(keyScreenmag,'mag-factor',5.3);
    assert.ok(ret);
};
...
process.addListener('exit',function() {
    // assert.ok(testBooleanValuesCallback1);
    // assert.ok(testBooleanValuesCallback2);
});