...
(function () {
    ...
    jqUnit.asyncTest("Getting single keys via gsettings handler", function() {
        setTimeout(function() {
    ...
    jqUnit.asyncTest("Setting single keys via gsettings handler", function() {
        setTimeout(function() {
    ...
    jqUnit.asyncTest("Setting multiple keys", function () {
        setTimeout(function() {
    ...
    jqUnit.asyncTest("Setting multiple keys in multiple schemas", function () {
        setTimeout(function() {
    ...
    jqUnit.asyncTest("Getting multiple keys in multiple schemas", function () {
        setTimeout(function() {
    ...
    jqUnit.asyncTest("Getting multiple keys with settings block as null", function () {
        setTimeout(function() {
    ...
    jqUnit.asyncTest("GPII-8 Not core dumping on a non-existent key", function () {
        setTimeout(function() {
