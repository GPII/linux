...
(function () {
    ...
    function applySettings(app) {
        ...
        var userSettings = gpii.getJSONFromFileSync(orcaSettingsFile);
    ...
    gpii.orca.set = function (profile) {
        ...
        returnObj['org.gnome.orca'][0].options = returnValue.options;
        returnObj['org.gnome.orca'][0].settings = returnValue.settings;
